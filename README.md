...
- smoothed player/enemy presentation polish, including lighter player bob/lean motion, smoother enemy turning and movement presentation, clearer enemy state indicators, lingering post-alert readability cues, generic enemy scene/class naming for future non-zombie enemy types, and data-driven archetype silhouettes/tell profiles
